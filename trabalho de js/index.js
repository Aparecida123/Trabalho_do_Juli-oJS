...
if(media>=6 && media <=10){
console.log(media)
alert('Passou, não fez mais que sua obrigação!')
...
var tempoTrab=parseInt(prompt("Digite quanto tempo passou trabalhando:"))
...
var quantidade=parseFloat(prompt("Digite a quantidade escolhida:"));
